...
sakura_pond = Pond('Sakura Pond', 1, 3, 4, [4, 3], False, [Koi, Goldfish, Catfish],
                   "A small, tranquil pond in a cherry blossom forest that many koi fish call home.")
aspen_river = Pond('Aspen River', 2,  9, 3, [6, 3], False, [Salmon, Bass, Trout],
                   "A narrow and winding river with a steady current.")
breezy_lake = Pond('Breezy Lake', 4, 7, 7, [6, 3], False, [Carp, Pike, Bass, Crappie, Perch],
                   "Large lake with a variety of fish.")
muddy_marsh = Pond('Muddy Marsh', 6, 8, 5, [8, 5], False, [Bass, Herring, Shad, Catfish, Perch],
                   "Muddy waters.")
radioactive_reservoir = Pond('Radioactive Resevoir', 8, 10, 9, [3, 3], False, [Dead_Fish, Mutant_Minnow, Glowfish],
                             "Most fish die here.")
furious_river = Pond('Furious River', 10, 12, 5, [5, 4], False, [Electric_Eel, Piranha, Payara, Bull_Shark],
                     "Dangerous!.")
open_ocean = Pond('Open Ocean', 12, 24, 24, [8, 6], True, [Herring, Jellyfish, Anchovy, Sardine, Great_White_Shark, Tuna],
                  "The big, open, middle of the sea.")
sapphire_pier = Pond('Sapphire Pier', 14, 6, 16, [5, 4], False,
                     [Flounder, Mullet, Hammerhead_Shark, Redfish, Mackerel, Croaker],
                     "")
desert_basin = Pond('Desert Basin', 15, 7, 8, [6, 5], False,
                    [Desert_Sucker, Loach_Minnow, Pupfish, Bonytail_Chub, Squawfish],
                    "")
rainbow_reef = Pond('Rainbow Reef', 18, 12, 12, [3, 2], False,
                    ...
                    "of ocean dwellers.")
kelp_forest = Pond('Kelp Forest', 20, 10, 12, [6, 4], False,
                   [Piece_of_Kelp, Sea_Turtle, Giant_Kelpfish, Rockfish, Bonito, Blue_Shark],
                   "")
killer_tooth_bay = Pond('Killer Tooth Bay', 22, 8, 13, [5, 3], True,
